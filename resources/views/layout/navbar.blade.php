<nav class="navbar navbar-expand-xl main-navbar" id="main-navbar">
    <img class="navbar-main-logo" src="{{ asset('images/logo/logo.png') }}" alt="logo" />
    <div id="navbarCollapse" class="collapse navbar-collapse align-items-center">
        <div class="navbar-nav ml-auto align-items-center">
            <div class="navbar-container container-fluid" id="navbar-container-search">
                <ul class="nav-left">
                    <li class="header-search">
                        <div class="search">
                            <div class="input-bar">
                                <input type="search" class="navbar-search" name="search" id="search-text" autocomplete="off" placeholder="Tìm kiếm" />
                                <button id="dictate">
            ...
            <a href="#" class="nav-item nav-link" id="change-theme-background">
                <i class="icon">
                    <svg width="20" height="20" viewBox="0 0 20 20">
                        <defs>
                            ...
                            <filter id="4a7imk8mze" width="230%" height="230%" x="-65%" y="-65%" filterUnits="objectBoundingBox"><feGaussianBlur in="SourceGraphic" stdDeviation="3.9"></feGaussianBlur></filter>

                            <filter id="301mo6jeah" width="312.7%" height="312.7%" x="-106.4%" y="-106.4%" filterUnits="objectBoundingBox"><feGaussianBlur in="SourceGraphic" stdDeviation="3.9"></feGaussianBlur></filter>

                            <filter id="b2zvzgq7fj" width="295%" height="295%" x="-97.5%" y="-97.5%" filterUnits="objectBoundingBox"><feGaussianBlur in="SourceGraphic" stdDeviation="3.9"></feGaussianBlur></filter>

                            <filter id="a1wq161tvl" width="256%" height="256%" x="-78%" y="-78%" filterUnits="objectBoundingBox"><feGaussianBlur in="SourceGraphic" stdDeviation="3.9"></feGaussianBlur></filter>
                        ...
                        <g fill="none" fill-rule="evenodd" transform="translate(2 3)">
                            <mask id="tinejqaasb" fill="#fff"><use xlink:href="#qtpqrj1oda"></use></mask>

                            <use fill="#FFF" fill-opacity="0" xlink:href="#qtpqrj1oda"></use>

                            <g mask="url(#tinejqaasb)">
                                <g transform="translate(-2 -3)">
                                    <mask id="uf3ckvfvpf" fill="#fff"><use xlink:href="#jggzvnjgfc"></use></mask>
            ...
            <a href="#" class="nav-item nav-link"><i class="fa fa-users"></i></a>
